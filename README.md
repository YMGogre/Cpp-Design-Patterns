...
<table>
    ...
    <tr>
        <td colspan="3" style="text-align:center; color:#E6A23C">💠 结构型模式（7 种）</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="3" style="text-align:center; color:#E6A23C">💠 行为型模式（11 种）</td>
    </tr>
    <tr>
...
<p style="text-align: right;">—— Christopher Alexander</p>
